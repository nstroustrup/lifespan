...
/users/nstroustrup/nstroustrup/projects/lifespan/bin/ns_image_server max_run_time_in_seconds 18000 idle_queue_check_limit 10 number_of_processor_cores_to_use 4 max_memory_to_use 8192 additional_host_description job:$JOB_ID:$TASK_ID
