...
struct ns_experiment_storyboard_timepoint_element{
	...
	ns_vector_2i event_object_size()const;
	ns_vector_2i event_image_size()const;
	ns_vector_2i image_object_size()const;
	ns_vector_2i image_image_size()const;
...
public:
	...
	void draw(const unsigned long sub_image_id,ns_image_standard & im,bool use_color,ns_sql & sql) const;
	...
	unsigned long label_margin_height() const;
	void draw_label_margin(const unsigned long sub_image_id,bool use_color,ns_image_standard & im) const;
};
...
public:
	...
	void save_image_to_db_no_error_handling(const unsigned long sub_image_id, const ns_experiment_storyboard_spec & spec, const ns_image_standard & im, ns_sql & sql) const;
