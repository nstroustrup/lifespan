...
typedef enum {NS_NULL, NS_TIMER, NS_IMAGE_REQUEST, NS_IMAGE_SEND,NS_STATUS_REQUEST, NS_QUIT, 
			  ...
			  NS_CLEAR_DB_BUF_CLEAN,NS_CLEAR_DB_BUF_DIRTY,NS_SIMULATE_CENTRL_DB_CONNECTION_ERROR,
			  NS_OUTPUT_IMAGE_BUFFER_INFO,NS_STOP_CHECKING_CENTRAL_DB,NS_START_CHECKING_CENTRAL_DB,NS_OUTPUT_SQL_LOCK_INFORMATION, 
			  NS_SIMULATE_LONG_TERM_STORAGE_ERROR
} ns_message_request;
