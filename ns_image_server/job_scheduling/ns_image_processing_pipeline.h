...
private:
	...
	ns_vector_2i get_vertical_registration(const ns_image_server_captured_image & captured_image, ns_image_server_image & source, ns_image_fast_registration_profile_cache::handle_t & requested_image, ns_image_fast_registration_profile_cache::external_source_type & external_source);
