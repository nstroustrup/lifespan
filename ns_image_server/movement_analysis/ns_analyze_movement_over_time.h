...
void analyze_worm_movement_across_frames(const ns_processing_job & job, ns_image_server * image_server, ns_sql & sql, bool log_output,long specific_worm=-1, ns_hmm_movement_analysis_optimizatiom_stats* optional_debug_results=0);
