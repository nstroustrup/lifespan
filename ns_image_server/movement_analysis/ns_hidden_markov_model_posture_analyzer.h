...
public:
	...
	ns_time_path_posture_movement_solution operator()(const ns_analyzed_image_time_path * path, std::ostream * debug_output_=0)const{return estimate_posture_movement_states(path,0,debug_output_);}
	ns_time_path_posture_movement_solution operator() (ns_analyzed_image_time_path * path, const bool fill_in_loglikelihood_timeseries,std::ostream * debug_output=0)const{return estimate_posture_movement_states(path,path,debug_output);}

	ns_time_path_posture_movement_solution estimate_posture_movement_states(const ns_analyzed_image_time_path * source_path, ns_analyzed_image_time_path * output_path = 0,std::ostream * debug_output=0) const;
