...
struct ns_cross_replicate_specification{
	...
	typedef enum { ns_all_data, ns_genotype_specific, ns_experiment_specific, ns_hmm_user_specified_specific,ns_genotype_experiment_specific } ns_cross_replicate_type;
