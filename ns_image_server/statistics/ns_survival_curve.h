...
public:
	...
	void output_JMP_file(const ns_time_handing_behavior & e, const ns_time_units & time_units,std::ostream & o,const ns_output_file_type& detail,const bool output_header=true) const ;
