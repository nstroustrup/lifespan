...
#$ -l virtual_free=8G,h_rt=72:00:00
#$ -pe smp 4
#$ -N ns_im_4    #job name
#$ -q long-sl7  #queue
#$ -t 1-10
...
/users/nstroustrup/nstroustrup/projects/lifespan/bin/ns_image_server max_run_time_in_seconds 252000 idle_queue_check_limit 50 number_of_processor_cores_to_use 4 max_memory_to_use 8192 additional_host_description 4_core:job:$JOB_ID:$SGE_TASK_ID ignore_multicore_jobs
