...
if ($show == "none"){
echo "<tr><td  bgcolor=\"{$table_colors[0][0]}\"><a href=\"manage_file_deletion_jobs.php?show=partial\">Click here to show pending deletion requests</a></td></tr>\n";
}
  ...
  echo "<tr><td  bgcolor=\"{$table_colors[0][0]}\">No Deletion Jobs are Ready for Processing.</td></tr>\n";
   ...
   for ($i = 0; $i < sizeof($jobs); $i++){
	...
	if ($s != $max)
		echo "<center>...<br><a href=\"manage_file_deletion_jobs.php?show=" . $show . "&show_details_id={$job_id}#id{$job_id}\">[View More]</a><center>";
...
<form method="post" action="manage_file_deletion_jobs.php">
<input name="confirm_all" type="submit" value="Confirm All Deletion Requests" onClick="javascript:return confirm('Are you sure you wish to confirm all deletion requests?  This is pretty dangerous.')">
</form>
</td></tr>
