...
function out_link($ex_id='',$dev_name='', $show_p ='',$show_f=''){
...
function out_limits_p(&$event_type,$limits){
  if ($event_type == 0)
...
$info = "SELECT capture_schedule.id, capture_schedule.experiment_id, capture_schedule.sample_id, capture_samples.device_name, capture_schedule.scheduled_time, "
      . "capture_schedule.time_at_start, capture_schedule.time_at_finish, capture_schedule.problem, capture_schedule.captured_image_id FROM capture_schedule, capture_samples " ;
$postfix_ASC = "";
